 ...
 public class TictTac extends javax.swing.JFrame {
...
//X wining condition//
    ...
    private void initComponents() {
        ...
        jLabel_score.setBackground(new java.awt.Color(0, 0, 102));
        ...
        jPanel_GridHolder.setBackground(new java.awt.Color(0, 153, 255));
        jPanel_GridHolder.setLayout(new java.awt.GridLayout(3, 3, 1, 1));

        jPanel_1.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jButton2.setFont(new java.awt.Font("Times New Roman", 1, 80)); // NOI18N
        ...
        jPanel_3.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jPanel_4.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jPanel_6.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jPanel_7.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jPanel_9.setBackground(new java.awt.Color(204, 204, 255));
        jPanel_9.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 204)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TictTac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
